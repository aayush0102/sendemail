package com.day.jcr.vault.emailworkflow.impl;
...
try
{
    ...
    //Set the mail values
    String emailToRecipients = "samplemail@xyz.com"; 
    String emailCcRecipients = "samplemail@abc.com"; 
      
    email.addTo(emailToRecipients);
    email.addCc(emailCcRecipients);
    email.setSubject("AEM Custom Step");
    email.setFrom("samplemail@xyz.com"); 
    
    String abc= (String) item.getWorkflowData().getPayload();
    log.info(abc);
    
    email.setMsg("This message is to inform you that the  "+ abc +"  CQ content has been deleted");
